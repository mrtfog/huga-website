...
const CourseDetails = () => {
  ...
  useEffect(() => {
    ...
    const query = `*[_type == "courses" && slug.current == $slug][0]{
      ...
      "video": courseIntroducingVideo.asset->url
    }`;
                ...
                <div className="course-payments__wrapper">
                  <div className="course-payments__payments_data">
                    <div className="course-payments__payments_description">
                      ...
                      <Typography as="p" variant="medium" color="darkGray">
                        Elige tu cursada con la modalidad que mejor se ajuste a
                        tus necesidades.
                      </Typography>
                      <Typography as="p" variant="medium" color="darkGray">
                        La matrícula es un pago único a realizar en cada inicio
                        de año. Es equivalente a la inscripción para todos los
                        cursos que el alumno decida realizar durante el mismo.
                      </Typography>
                    </div>
                    <div className="course-payments__payments_pricing">
                      ...
                      {currentCourse &&
                      currentCourse.asyncCourseAvailability ? (
                ...
                <div className="course-promotion-hook__wrapper">
                  <div className="course-promotion-hook__container">
                    <div className="course-promotion-hook__description">
                      ...
                      <Typography as="p" variant="medium" color="darkGray">
                        Todos nuestros cursos finalizan con un TP Final
                        integrador a través del cuál el alumno podrá evaluar sus
                        habilidades adquiridas y recibir una certificación de
                        cursada y aprobación del mismo. Una vez finalizado el
                        curso, el estudio ofrece una sesión de coaching
                        profesional y asesoramiento gratuito para aquellos
                        alumnos que deseen iniciar sus carreras en el rubro ya
                        sea para la búsqueda laboral o el desarrollo de trabajos
                        independientes, así como también la creación de sus
                        propias marcas.
                      </Typography>
                      <Typography as="p" variant="medium" color="darkGray">
                        ¡Alentamos a que todos aquellos que se interesen por
                        vivir de la moda puedan hacerlo y crear su propio camino
                        profesional!
                      </Typography>
                    </div>
